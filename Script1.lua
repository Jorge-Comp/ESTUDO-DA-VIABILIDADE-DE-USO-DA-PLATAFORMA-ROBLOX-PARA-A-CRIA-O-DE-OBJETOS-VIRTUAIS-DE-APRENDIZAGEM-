...
Prompt_proximidade.ObjectText = "Liquido" --Mude a sua preferencia o nome do item
...
    local Item = game:GetService("ReplicatedStorage").Liquido --Mude aqui para o nome EXATO do item!
